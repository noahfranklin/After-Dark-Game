...
import { ShieldAlert, LogOut, Flame, Heart, User } from "lucide-react";
...
export default function GameRoomPage() {
  ...
  useEffect(() => {
    // Read test_user cookie to know who "I" am
  ...
  const drawCard = () => {
    if (!isMyTurn) return; // Prevent drawing if not my turn
        ...
        <div className="flex items-center gap-6 glass px-6 py-2 rounded-full border border-white/10">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-muted-foreground">{currentPlayer}</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <div className="flex flex-col text-right">
              ...
              <span className="text-[10px] text-muted-foreground">{otherPlayer} (Remote)</span>
            </div>
